...
class GoogleAPIClient:
    ...
    def batch_update(self, spreadsheet):
        ...
        self._sheets_service.spreadsheets().batchUpdate(spreadsheetId=spreadsheet.spreadsheet_id, body=spreadsheet.to_dict()).execute()
        spreadsheet.reset_updates()

    def query_gsc(self, siteUrl, payload):
        response = self._gsc_service.searchanalytics().query(siteUrl = siteUrl, body = payload).execute()
        return response